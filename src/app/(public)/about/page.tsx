...
export default function AboutPage() {
  return (
    <>
      <PageHero
        pillText="Lions Club Baroda Rising Star · About"
        headline="Service is the rent we pay"
        accent="for our space on Earth"
        subtitle="Chartered under District 3232-F1 · part of Lions Clubs International, the world's largest service organisation."
      />
